...
/* Display Settings */
$conf['recent']      = 999;                //how many entries to show in recent
$conf['recent_days'] = 21;                 //How many days of recent changes to keep. (days)
...
$conf['dformat']     = '%Y-%m-%d %H:%M %Z';  //dateformat accepted by PHPs strftime() function
...
$conf['defaultgroup']= 'users';           //Default groups new Users are added to
$conf['superuser']   = '@admins';    //The admin can be user or @group or comma separated list user1,@group1,user2
$conf['manager']     = '@managers';    //The manager can be user or @group or comma separated list user1,@group1,user2
...
$conf['rss_type']    = 'rss1';           //type of RSS feed to provide, by default:
                                         ...
                                         //  'atom' - Atom 0.3
                                         //  'atom1' - Atom 1.0
$conf['rss_linkto'] = 'page';            //what page RSS entries link to:
...
$conf['sepchar']     = '-';              //word separator character in page names; may be a
                                         //  letter, a digit, '_', '-', or '.'.
